...
urlpatterns = [
    ...
    path(r'bucketdevice/<int:source_id>/<str:report_group>/<str:meas>/<str:dev_eui>/<start_mark>/<end_mark>/',
         bucketdevice, name='bucketdevice_withtimes'),
    path(r'bucketdevice/<int:source_id>/<str:report_group>/<str:meas>/<str:dev_eui>/', bucketdevice, name='bucketdevice_source'),
